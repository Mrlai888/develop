   ...
   function Selected() {
    ...
    //                 if (that.checkbox[j].innerText) {
    //                     // console.log(that.checkbox[j].index);
    //                     Jin_All = Jinsrc.substr(1) * 1 * text[this.index].pSum + '.00';
    //                     that.Jin_sum_price[this.index].innerText = Jin_All;

    //                     console.log(that.Jin_sum_price[that.checkbox[j].index].innerText * 1);


    //                      that.Jin_sum_All.innerText = that.Jin_sum_price[that.checkbox[j].index].innerText;
    ...
    //             //
    //             // if ((that.checkbox[this.index]).innerText) {
    //             //     that.Jin_sum_All.innerText = that.Jin_sum_price[this.index].innerText
    //             // }
    //         }
    //         jian[i].onclick = function () {
    //             (text[this.index].pSum)--;
